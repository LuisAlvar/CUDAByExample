...
// nvcc -Llib ./MultipleStreamsEff.cu -o ./bin/MultipleStreamsEff.exe
// First run:
// Time take: 412.0 ms
...
int main ( void ) {
  ...
  for (int i = 0; i < FULL_DATA_SIZE; i += N * 2)
  {
    ...
    //enqueu kernesl in stream0 and stream1
  ...
  printf("Time take: %3.1f ms\n", elapsedTime);

  // clenup the streams and memory 
